...
class DataSet(Dataset):
	...
	def __init__(self, 
		...
		self.mapping = {v: i for i, v in enumerate('_0123456789+-*乘加减')}
	...
	def __getitem__(self, item):
		...
		label = [0 for _ in range(8 - len(self.labels[item]))]
		for c in self.labels[item]:
			label.append(self.mapping.get(c))
